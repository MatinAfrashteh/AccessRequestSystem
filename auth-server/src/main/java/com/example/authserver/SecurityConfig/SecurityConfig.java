package com.example.authserver.SecurityConfig;
...
//        RegisteredClient oidccreClient = RegisteredClient.withId(UUID.randomUUID().toString())
...
//                .clientId("introspecClient")
//                .clientSecret("{noop}kbytZgAXyyTq9lkjj3qGvWNsHtE4SqTq")
//                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
//                .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS)
//                .scopes(scopes -> scopes.addAll(List.of(OidcScopes.OPENID,"USER","ADMIN")))
//                .tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofMinutes(10))
//                        .accessTokenFormat(OAuth2TokenFormat.REFERENCE).build())
//                .build();
//
        RegisteredClient authCodeClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .scopes(scopes -> scopes.addAll(List.of(OidcScopes.OPENID, "email", "roles")))
            ...
            if (context.getTokenType().equals(OAuth2TokenType.ACCESS_TOKEN)) {
                context.getClaims().claims(claims -> {
                    if (context.getAuthorizationGrantType().equals(AuthorizationGrantType.CLIENT_CREDENTIALS)) {
                        Object scopes = context.getClaims().build().getClaim("scope");
                        claims.put("role", scopes);
